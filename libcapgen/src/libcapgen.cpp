...
EMSCRIPTEN_BINDINGS(libcapgen)
{
    ...
    value_array<MarginConstraints>("MarginConstraints")
        .element(&MarginConstraints::domestic_equity)
        .element(&MarginConstraints::global_equity)
        .element(&MarginConstraints::real_estate)
        .element(&MarginConstraints::alternative)
        .element(&MarginConstraints::credit)
        .element(&MarginConstraints::bonds_2y)
        .element(&MarginConstraints::bonds_5y)
        .element(&MarginConstraints::cash)
        .element(&MarginConstraints::fta)
